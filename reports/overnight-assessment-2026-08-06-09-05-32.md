# Overnight System Assessment Report - 2026-08-06 09-05-32

## Executive Summary

**Overall Health Score:** 100/100

**Assessment Time:** 2026-08-06T02:05:32.985Z
...
|---------|--------|---------------|-------|
| Caddy | ✅ Healthy | 312ms | Status: 200 |
| BServer | ✅ Healthy | 21ms | Status: 200 |
| Status API | ✅ Healthy | 8ms | Status: 200 |
| Yomi API | ✅ Healthy | 7ms | Status: 200 |
| Yomi Summarization | ✅ Healthy | 20ms | Status: 200 |
| Yomi Rate Limiter | ✅ Healthy | 131ms | Status: 200 |
| Trade API | ✅ Healthy | 193ms | Container: Up 24 hours |
| Trading Terminal | ✅ Healthy | 125ms | Container: Up 37 hours |
| Redis | ✅ Healthy | 121ms | Container: Up 37 hours (healthy) |
| Postgres | ✅ Healthy | 288ms | Container: Up 37 hours (healthy) |
| Weaviate | ✅ Healthy | 9ms | Status: 200 |
| Llama Router (Phi-3 only) | ✅ Healthy | 10ms | Status: 200 - Thai legal model offline (2026-08-06) due to GPU memory constraints |
| Imagen2 | ✅ Healthy | 17ms | Status: 200 - Offline (2026-08-06) due to GPU memory constraints |
| Txt2Vid | ✅ Healthy | 8ms | Status: 200 - Offline (2026-08-06) due to GPU memory constraints |
| GPU Queue | ✅ Healthy | 10ms | Status: 200 |
| Activepieces | ✅ Healthy | 294ms | Container: Up 37 hours |
| Frigate NVR | ❌ Unhealthy | 13ms | Status: 502 - Offline (2026-08-06) due to 502 errors - needs investigation |
| Camera Control | ✅ Healthy | 12ms | Status: 200 |
...
Mem:            30Gi        19Gi       4.4Gi       1.3Gi       8.2Gi        10Gi
Swap:           47Gi        39Gi       8.0Gi
```

**System Load:**
```
09:05:35 up 1 day, 14:16,  2 users,  load average: 28.76, 25.58, 20.71
```
...
**Assessment Duration:** 136s
**Generated by:** Automated Overnight Assessment System
**Report Location:** /home/tony/CascadeProjects/chaba/reports/overnight-assessment-2026-08-06-09-05-32.md
