# Overnight System Assessment Report - 2026-08-06 08-58-57

## Executive Summary

**Overall Health Score:** 100/100

**Assessment Time:** 2026-08-06T01:58:57.965Z
...
|---------|--------|---------------|-------|
| Caddy | ✅ Healthy | 34ms | Status: 200 |
| BServer | ✅ Healthy | 5ms | Status: 200 |
| Status API | ✅ Healthy | 5ms | Status: 200 |
| Yomi API | ✅ Healthy | 3ms | Status: 200 |
| Yomi Summarization | ✅ Healthy | 11ms | Status: 200 |
| Yomi Rate Limiter | ✅ Healthy | 61ms | Status: 200 |
| Trade API | ✅ Healthy | 56ms | Container: Up 24 hours |
| Trading Terminal | ✅ Healthy | 44ms | Container: Up 37 hours |
| Redis | ✅ Healthy | 58ms | Container: Up 37 hours (healthy) |
| Postgres | ✅ Healthy | 48ms | Container: Up 37 hours (healthy) |
| Weaviate | ✅ Healthy | 4ms | Status: 200 |
| Llama Router (Phi-3 only) | ✅ Healthy | 4ms | Status: 200 |
| Imagen2 | ✅ Healthy | 8ms | Status: 200 |
| Txt2Vid | ✅ Healthy | 6ms | Status: 200 |
| GPU Queue | ✅ Healthy | 9ms | Status: 200 |
| Activepieces | ✅ Healthy | 44ms | Container: Up 37 hours |
| Frigate NVR | ❌ Unhealthy | 4ms | Status: 502 |
| Camera Control | ✅ Healthy | 5ms | Status: 200 |
...
Mem:            30Gi        17Gi       6.6Gi       1.0Gi       7.8Gi        12Gi
Swap:           47Gi        40Gi       7.7Gi
```

**System Load:**
```
08:58:58 up 1 day, 14:09,  2 users,  load average: 18.02, 22.93, 17.93
```
...
**Report Location:** /home/tony/CascadeProjects/chaba/reports/overnight-assessment-2026-08-06-08-58-57.md
