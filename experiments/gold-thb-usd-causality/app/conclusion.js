  ...
  try {
    ...
    const traces = [
      ...
      },
      {
        ...
        y: bh,
        mode: "lines",
        name: "Buy-and-hold XAU (same days)",
        line: { color: "#6c757d" },
      },
    ];
