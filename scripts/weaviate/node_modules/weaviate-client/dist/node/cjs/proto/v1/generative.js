...
exports.GenerativeProvider = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        ...
        if (message.deepseek !== undefined) {
            exports.GenerativeDeepseek.encode(message.deepseek, writer.uint32(130).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 16:
                    ...
                    message.deepseek = exports.GenerativeDeepseek.decode(reader, reader.uint32());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return {
            ...
            deepseek: isSet(object.deepseek) ? exports.GenerativeDeepseek.fromJSON(object.deepseek) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.deepseek !== undefined) {
            obj.deepseek = exports.GenerativeDeepseek.toJSON(message.deepseek);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.deepseek = (object.deepseek !== undefined && object.deepseek !== null)
            ? exports.GenerativeDeepseek.fromPartial(object.deepseek)
            : undefined;
        return message;
    },
};
...
function createBaseGenerativeDeepseek() {
    return {
        baseUrl: undefined,
        model: undefined,
        temperature: undefined,
...
exports.GenerativeDeepseek = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        ...
        if (message.stop !== undefined) {
            base_js_1.TextArray.encode(message.stop, writer.uint32(66).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
    ...
    create(base) {
        return exports.GenerativeDeepseek.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseGenerativeDeepseek();
        message.baseUrl = object.baseUrl ?? undefined;
...
function createBaseGenerativeDeepseekMetadata() {
    return { usage: undefined };
}
exports.GenerativeDeepseekMetadata = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        if (message.usage !== undefined) {
            exports.GenerativeDeepseekMetadata_Usage.encode(message.usage, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.usage = exports.GenerativeDeepseekMetadata_Usage.decode(reader, reader.uint32());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return { usage: isSet(object.usage) ? exports.GenerativeDeepseekMetadata_Usage.fromJSON(object.usage) : undefined };
    },
    toJSON(message) {
        const obj = {};
        if (message.usage !== undefined) {
            obj.usage = exports.GenerativeDeepseekMetadata_Usage.toJSON(message.usage);
        }
        return obj;
    },
    create(base) {
        return exports.GenerativeDeepseekMetadata.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseGenerativeDeepseekMetadata();
        message.usage = (object.usage !== undefined && object.usage !== null)
            ? exports.GenerativeDeepseekMetadata_Usage.fromPartial(object.usage)
            : undefined;
        return message;
    },
};
function createBaseGenerativeDeepseekMetadata_Usage() {
    return { promptTokens: undefined, completionTokens: undefined, totalTokens: undefined };
}
exports.GenerativeDeepseekMetadata_Usage = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        if (message.promptTokens !== undefined) {
            writer.uint32(8).int64(message.promptTokens);
        }
    ...
    create(base) {
        return exports.GenerativeDeepseekMetadata_Usage.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseGenerativeDeepseekMetadata_Usage();
        message.promptTokens = object.promptTokens ?? undefined;
...
exports.GenerativeMetadata = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        ...
        if (message.deepseek !== undefined) {
            exports.GenerativeDeepseekMetadata.encode(message.deepseek, writer.uint32(114).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 14:
                    ...
                    message.deepseek = exports.GenerativeDeepseekMetadata.decode(reader, reader.uint32());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return {
            ...
            deepseek: isSet(object.deepseek) ? exports.GenerativeDeepseekMetadata.fromJSON(object.deepseek) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.deepseek !== undefined) {
            obj.deepseek = exports.GenerativeDeepseekMetadata.toJSON(message.deepseek);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.xai = (object.xai !== undefined && object.xai !== null)
            ...
            : undefined;
        message.deepseek = (object.deepseek !== undefined && object.deepseek !== null)
            ? exports.GenerativeDeepseekMetadata.fromPartial(object.deepseek)
            : undefined;
        return message;
    },
};
