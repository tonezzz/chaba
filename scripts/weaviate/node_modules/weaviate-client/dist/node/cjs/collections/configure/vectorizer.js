...
const makeVectorIndex = (opts) => {
    ...
    if (opts?.quantizer) {
        ...
        else if (!parsing_js_1.VectorIndexGuards.isHFresh(conf)) {
...
const makeVectorizer = (name, options, multiVec) => {
    const userProvidedIndex = options?.vectorIndexConfig !== undefined ||
...
const __vectors_shaded = {
    ...
    text2VecDigitalOcean: (opts) => legacyVectors.text2VecDigitalOcean(opts),
