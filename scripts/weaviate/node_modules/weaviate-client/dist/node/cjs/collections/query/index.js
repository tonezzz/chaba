...
exports.Diversity = exports.Bm25Operator = exports.queryFactory = void 0;
...
class QueryManager {
    ...
    fetchObjectById(id, opts, callOpts) {
        return this.check
    ...
    nearMedia(media, type, opts, callOpts) {
        return this.check
            .nearSearch(callOpts)
            .then(({ search }) => {
            let send;
...
Object.defineProperty(exports, "Diversity", { enumerable: true, get: function () { return utils_js_1.Diversity; } });
