...
exports.makeVectorsConfig = exports.parseVectorizerConfig = exports.parseVectorIndex = exports.classToCollection = exports.resolveReference = exports.resolveProperty = exports.ReferenceTypeGuards = exports.textAnalyzerConfigFromWire = exports.textAnalyzerConfigToWire = void 0;
 ...
 */
const textAnalyzerConfigToWire = (config) => {
    if (config == undefined)
        return undefined;
    const out = {
...
exports.textAnalyzerConfigToWire = textAnalyzerConfigToWire;
/**
 ...
 */
const textAnalyzerConfigFromWire = (wire) => {
    if (wire == undefined)
        return undefined;
    const out = {};
    if (wire.stopwordPreset != undefined)
        out.stopwordPreset = wire.stopwordPreset;
...
exports.textAnalyzerConfigFromWire = textAnalyzerConfigFromWire;
...
const resolveProperty = (prop, vectorizers) => {
    const { dataType, nestedProperties, skipVectorization, vectorizePropertyName, textAnalyzer, ...rest } = prop;
    const moduleConfig = {};
    ...
    return {
        ...
        textAnalyzer: (0, exports.textAnalyzerConfigToWire)(textAnalyzer),
    };
};
...
const makeVectorsConfig = (configVectorizers) => {
    ...
    vectorizersConfig.forEach((v) => {
        const vectorConfig = { vectorizer: {} };
        if (v.vectorIndex) {
            vectorConfig.vectorIndexConfig = (0, exports.parseVectorIndex)(v.vectorIndex);
    ...
    static properties(v) {
        ...
        return v
            ...
            return {
                ...
                textAnalyzer: (0, exports.textAnalyzerConfigFromWire)(prop.textAnalyzer),
            };
        });
    }
    static references(v) {
