...
export class DbVersionSupport {
    ...
    supportsTokenizeStopwords = () => this.dbVersionProvider.getVersion().then((version) => ({
        version,
    ...
    supportsServerSideDefaultVectorIndexType = () => this.dbVersionProvider.getVersion().then((version) => ({
        version,
