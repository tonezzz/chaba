...
import { BM25, Hybrid, NearAudioSearch, NearDepthSearch, NearIMUSearch, NearImageSearch, NearObject, NearTextSearch, NearThermalSearch, NearVector, NearVideoSearch, Selection, Targets, VectorForTarget } from '../../proto/v1/base_search.js';
...
import { Boost as BoostGRPC, GroupBy } from '../../proto/v1/search_get.js';
...
import { AggregateBaseOptions, AggregateHybridOptions, AggregateNearOptions, BatchReference, BoostOptions, DiversityConfig, GenerativeConfigRuntime, GroupByAggregate, GroupedTask, PropertiesMetrics, SinglePrompt } from '../index.js';
...
export declare class MetadataGuards {
    ...
    static isAll: (argument?: QueryMetadata) => boolean;
    static isAllAndQueryProfile: (argument?: QueryMetadata) => boolean;
...
declare class Search {
    ...
    static selection: (diversity?: DiversityConfig) => Selection | undefined;
...
export declare class Serialize {
    ...
    private static boostCurve;
    private static boostModifier;
    static boostGRPC: (boost: BoostOptions) => BoostGRPC;
