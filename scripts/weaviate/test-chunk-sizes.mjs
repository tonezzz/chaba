...
`;
  ...
  try {
    ...
    console.log(
      `Chunk length stats: avg ${Math.round(avgLength)}, min ${minLength}, max ${maxLength}`
    );
...
async function compareChunkSizes() {
  ...
  console.log(
    "Consider testing with real search queries to determine optimal size for your use case."
  );
