...
echo "  docker compose -f stacks/ai/docker-compose.yml run colmap"
echo "  docker compose -f stacks/ai/docker-compose.yml run 3dgs train -s /data/scene -m /outputs/scene"
echo "  docker compose -f stacks/ai/docker-compose.yml run nerfstudio train --data /data/processed"
echo "  docker compose -f stacks/ai/docker-compose.yml run -e VARIANT=2dgs variants train -s /data/scene -m /outputs/2dgs"
echo "  docker compose -f stacks/ai/docker-compose.yml run john test"
echo "  docker compose -f stacks/ai/docker-compose.yml up jupyter"
