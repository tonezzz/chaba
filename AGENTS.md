...
- Key ops: `scripts/ada-key-url.sh <tony|michael|ada-pi> [--qr]` prints the unlock deep-link; `scripts/rotate-ada-key.sh <instance>` rotates + restarts + prints the new link.
