...
if (typeof Strategy === "undefined") {
  console.error(
    "Strategy class not available. Ensure strategies.js is loaded before hindsight-strategies.js"
  );
} else {
  /**
  ...
  class Hindsight01Strategy extends Strategy {
    ...
    autoDetectPoints() {
      ...
      console.log(
        `Processing ${this.data.length} data points for Hindsight-01 (3-point confirmation)...`
      );
      ...
      console.log(
        `Hindsight-01: ${this.buyPoints.length} buy points, ${this.sellPoints.length} sell points`
      );
    }
