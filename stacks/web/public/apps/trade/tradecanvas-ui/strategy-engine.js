...
class StrategyPanel {
  ...
  init() {
    ...
    this.resultContainer.innerHTML =
      '<p style="color:#8b949e; font-size:13px; margin-top:6px;">Click "Run Backtest" to see results.</p>';
  }
  ...
  buildControls() {
    ...
    html +=
      '<button id="run-backtest" class="btn" style="width:100%; margin-top:10px;">Run Backtest</button>';

    this.controlsContainer.innerHTML = html;

    document
      .getElementById("strategy-select")
      .addEventListener("change", () => this.renderParams());
    this.renderParams();
