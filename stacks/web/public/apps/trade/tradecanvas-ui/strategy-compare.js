...
class StrategyPanel {
  ...
  buildControls() {
    ...
    html +=
      '<button id="run-all" class="btn" style="width:100%; margin-top:4px; padding:8px; font-size:12px;" onclick="window.runAllWithFeedback()">Run All & Compare</button>';
  ...
  renderHindsightParams(container, key) {
    ...
    html +=
      '<div style="display:grid; grid-template-columns: 1fr 1fr; gap:4px; margin-bottom:4px;">';
    html +=
      '<button id="redetect-points" class="btn" style="width:100%; padding:6px; font-size:11px; background:#238636; border-color:#238636;">Re-detect All</button>';
    html +=
      '<button id="clear-points" class="btn" style="width:100%; padding:6px; font-size:11px; background:#da3633; border-color:#da3633;">Clear Manual</button>';
    html += "</div>";
    ...
    document
      ...
      .addEventListener("click", () => this.clearManualPoints());
