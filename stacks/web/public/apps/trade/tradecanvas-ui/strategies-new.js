...
class ManualPerfectStrategy extends Strategy {
  constructor(
    parameters = { buy_points: [], sell_points: [], auto_detect: false, algorithm: "sensitive" }
  ) {
  ...
  autoDetectSensitive() {
    console.log(
      `Processing ${this.data.length} data points for auto-detection using sensitive trend algorithm...`
    );
    ...
    console.log(
      `Auto-detected ${this.buyPoints.length} buy points and ${this.sellPoints.length} sell points using sensitive trend algorithm`
    );
  }

  autoDetectConservative() {
    console.log(
      `Processing ${this.data.length} data points for auto-detection using 3-point trend confirmation...`
    );
    ...
    console.log(
      `Auto-detected ${this.buyPoints.length} buy points and ${this.sellPoints.length} sell points using 3-point trend confirmation`
    );
  }
