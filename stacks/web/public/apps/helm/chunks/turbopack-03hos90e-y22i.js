((globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  "object" == typeof document ? document.currentScript : void 0,
  {
    otherChunks: [
      ...
      "static/chunks/25__uzlejexju.js",
  ...
  (() => {
    ...
    u.a = function (e, t) {
      let r = this.m,
        ...
        o = new Set(),
        { resolve: l, reject: i, promise: u } = C(),
        s = Object.assign(u, {
          [v]: r.exports,
          [k]: (e) => {
    ...
    async function x(e, t, r) {
      ...
      for (let l of ((n = M(e, t, K(r.path))), o)) $.has(l) || $.set(l, n);
      await n;
    }
    P.l = function (e) {
      return x(o.Parent, this.m.id, e);
    };
