...
nohup podman exec -i -e "HA_LONG_LIVED_TOKEN=$HA_LONG_LIVED_TOKEN" home-assistant python3 /config/ha-live/bridge.py > /home/tony/.config/home-assistant/ha-live/bridge.log 2>&1 &
